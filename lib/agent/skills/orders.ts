...
- days_late > 0 = late. If carrier_trace_available, call open_carrier_trace and give the reference. If delay_voucher_eligible and the delay bothers them, call issue_delay_voucher. Code picks the reward (delay_voucher_reward: 5% off, free shipping or a gift card) from the order size and delay; name exactly that one, never offer a bigger one.
